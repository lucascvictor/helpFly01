			...
			<table class="display striped responsive nowrap dataTable no-footer dtr-inline" width="100%" id="fly01dt" role="grid" aria-describedby="fly01dt_info" style="width: 100%;">
				<thead>
					<tr id="columns" role="row">
						<th class="sorting_asc" tabindex="0" aria-controls="fly01dt" rowspan="1" colspan="1" style="width: 274px;" aria-sort="ascending" aria-label="searchDescri��o: Ordenar colunas de forma descendente">
							<div id="descricaoField" class="input-field fly01dt-filter ">
								<input id="descricao" name="descricao" type="search">
									<i class="material-icons">search</i>
									<label class="truncate" for="descricao">Descri��o</label>
								</div>
							</th>
							<th class="sorting_disabled" rowspan="1" colspan="1" style="width: 43px;" aria-label="">
								<span/>
							</th>
						</tr>
					</thead>
					<tbody>
						<tr role="row" class="odd">
							...
							<td nowrap="nowrap">
								<input type="hidden" class="rowRecordId" value="72c1da45-e715-4fc6-b9ed-3e1802f67063">
									<a class="fly01-dt-menu right dropdown-button" href="javascript:void(0)" data-activates="dropdown0">
										<i class="material-icons">more_vert</i>
									</a>
									<ul id="dropdown0" class="dropdown-content">
										<li>
											<a href="javascript:void(0)" onclick="fnEditar('72c1da45-e715-4fc6-b9ed-3e1802f67063')">Editar</a>
										</li>
										<li>
											<a href="javascript:void(0)" onclick="fnExcluir('72c1da45-e715-4fc6-b9ed-3e1802f67063')">Excluir</a>
										</li>
									</ul>
								</td>
							</tr>
							<tr role="row" class="even">
								...
								<td nowrap="nowrap">
									<input type="hidden" class="rowRecordId" value="334c4315-aec7-4cea-923d-bca87944b45a">
										<a class="fly01-dt-menu right dropdown-button" href="javascript:void(0)" data-activates="dropdown1">
											<i class="material-icons">more_vert</i>
										</a>
										<ul id="dropdown1" class="dropdown-content">
											<li>
												<a href="javascript:void(0)" onclick="fnEditar('334c4315-aec7-4cea-923d-bca87944b45a')">Editar</a>
											</li>
											<li>
												<a href="javascript:void(0)" onclick="fnExcluir('334c4315-aec7-4cea-923d-bca87944b45a')">Excluir</a>
											</li>
										</ul>
									</td>
								</tr>
