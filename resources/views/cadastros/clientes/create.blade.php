...
<div class="container">
	<div class="row">
		<form id="" class="col s12" action="https://novofaturamento.fly01.com.br/RegisterPerson/Edit" method="post" novalidate="novalidate" data-vivaldi-spatnav-clickable="1">
			...
			<div data-tour-index="0" data-tour-title="Grupo" data-tour-description="Grupo de carinhas agrupados" height="200px">
				...
				<div id="nameField" class="input-field col s12 l8">
					<input id="name" type="text" name="name" data-tour-index="2" data-tour-title="Razão Social/Nome" data-tour-description="Aqui você coloca o seu Nome completo / Razão social, sem abreviações">
					</input>
			...
			<div id="typeField" class="input-field col s6 m3">
				...
				<div id="stateInscriptionField" class="input-field col s6 m3">
					<input id="stateInscription" type="text" name="stateInscription" readonly="readonly"/>
				...
				<div id="chkIsentoField" class="input-field col s12 l4">
					<p>
						<input id="chkIsento" type="checkbox" name="chkIsento" value="true"/>
				...
				<div id="personTypeNfseField" class="input-field col s12 l4">
					<div class="select-wrapper">
						...
						<input type="text" class="select-dropdown" readonly="true" data-activates="select-options-j7dxbxz" value="Outro">
							<ul id="select-options-j7dxbxz" class="dropdown-content select-dropdown ">
								...
								<li class="" data-vivaldi-spatnav-clickable="1">
									<span>Legislativo/Judiciário</span>
								</li>
							</ul>
					...
					<div id="municipalInscriptionField" class="input-field col s12 l4">
						<input id="municipalInscription" type="text" name="municipalInscription" class="masked numbers" style="text-align: right;"/>
					...
					<div id="simplesNacionalBoolField" class="input-field col s12 l4">
						<p>
							<input id="simplesNacionalBool" type="checkbox" name="simplesNacionalBool" value="true"/>
					...
					<div id="otherCityField" class="input-field col s12 m6 l4">
						<input type="hidden" name="otherCity" id="otherCity" value=""/>
						<input type="text" class="autocomplete ui-autocomplete-input" id="otherCityAutoComplete" name="otherCityAutoComplete" data-url="/AutoComplete/CityIbgeCode" data-target="otherCity" autocomplete="off"/>
					...
					<div id="stateField" class="input-field col s12 m6 l3">
						...
						<div id="cityField" class="input-field col s12 m6 l6">
						...
						<div id="addressField" class="input-field col s12">
						...
						<div id="isSupplierBoolField" class="input-field col s12 l4">
							<p>
								<input id="isSupplierBool" type="checkbox" name="isSupplierBool" value="true"/>
								<label class="truncate" for="isSupplierBool">É Fornecedor</label>
							</p>
						</div>
						<div id="isCarrierBoolField" class="input-field col s12 l4">
							<p>
								<input id="isCarrierBool" type="checkbox" name="isCarrierBool" value="true"/>
								<label class="truncate" for="isCarrierBool">É Transportadora
								</label>
							</p>
						</div>
					</form>
