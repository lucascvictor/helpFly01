                              ...
                              <div class="picker__container__wrapper">
                                 <div class="picker__calendar-container">
                                    <div class="picker__header">
                                       <select class="picker__select--month browser-default" disabled="" aria-controls="dataPgto_table" title="Escolha um mês">
                                       ...
                                       <select class="picker__select--year browser-default" disabled="" aria-controls="dataPgto_table" title="Escolha um ano">
                                       ...
                                       <div class="picker__nav--prev" data-nav="-1" role="button" aria-controls="dataPgto_table" title="Anterior"> </div>
                                       <div class="picker__nav--next picker__nav--disabled" data-nav="1" role="button" aria-controls="dataPgto_table" title="Proximo"> </div>
                                    </div>
                                    <table class="picker__table" id="dataPgto_table" role="grid" aria-controls="dataPgto" aria-readonly="true">
                                       <thead>
                                          <tr>
                                 ...
                                 <div class="picker__footer"><button class="picker__today btn-flat" type="button" data-pick="1522897200000" disabled="" aria-controls="dataPgto">Hoje</button><button class="picker__clear btn-flat" type="button" data-clear="1" disabled="" aria-controls="dataPgto">Limpar</button><button class="picker__close btn-flat" type="button" data-close="true" disabled="" aria-controls="dataPgto">Fechar</button></div>
                              </div>
                           </div>
                        </div>
                     </div>
