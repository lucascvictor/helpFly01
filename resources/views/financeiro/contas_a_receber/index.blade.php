         ...
         <form id="fly01frm" class="col s12" method="post" novalidate="novalidate">
            <div id="mesPickerField" class="input-field col s12 m6 offset-m3 l4 offset-l4">
               ...
               <div id="mesPickercontainer" class="col s8 btn zero-border-radius">
                           ...
                           <div class="picker__wrap">
                              <div class="picker__box">
                                 <div class="picker__date-display">
                                    ...
                                    <span class="picker__month-display">Abril </span>
                                 </div>
                                 <div class="picker__container__wrapper">
                                    <div class="picker__calendar-container">
                                       ...
                                       <table class="picker__table" id="mesPicker_table" role="grid" aria-controls="mesPicker" aria-readonly="true">
                                          ...
                                          <tbody>
                                             ...
                                             <tr>
                                                <td role="presentation">
                                                   <div class="picker__month picker__day--infocus picker__day--today picker__day--selected picker__day--highlighted" data-pick="1522551600000" role="gridcell" aria-label="Abril, 2018" aria-activedescendant="true" tabindex="0">Abr</div>
                                                </td>
                                                <td role="presentation">
                                    ...
                                    <div class="picker__footer"><button class="picker__today btn-flat" type="button" data-pick="1522551600000" disabled="" aria-controls="mesPicker">Hoje</button><button class="picker__clear btn-flat" type="button" data-clear="1" disabled="" aria-controls="mesPicker">Limpar</button><button class="picker__close btn-flat" type="button" data-close="true" disabled="" aria-controls="mesPicker">Fechar</button></div>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <input id="mesPicker" name="mesPicker" class="btn truncate periodpicker picker__input" data-value="Sun Apr 01 2018 00:00:00 GMT-0300 (BRT)" readonly="" tabindex="-1" aria-haspopup="true" aria-expanded="false" aria-readonly="false" aria-owns="mesPicker_root" type="text">
               </div>
            ...
            <input id="dataFinal" name="dataFinal" value="2018-04-30" type="hidden"><input id="dataInicial" name="dataInicial" value="2018-04-01" type="hidden">
         </form>
               ...
               <thead>
                  <tr id="columns" role="row">
                     <th class="sorting_asc" tabindex="0" aria-controls="fly01dt" rowspan="1" colspan="1" style="width: 127px;" aria-sort="ascending" aria-label="Em abertoPagoRenegociadoBaixado ParcialmenteStatus: Ordenar colunas de forma descendente">
                        <div id="statusContaBancariaField" class="input-field fly01dt-select ">
                           <div class="select-wrapper initialized">
                              <span class="caret">▼</span><input class="select-dropdown" readonly="true" data-activates="select-options-jjwp9od" value="" data-constrainwidth="undefined" type="text">
                              <ul id="select-options-jjwp9od" class="dropdown-content select-dropdown ">
                              ...
                              <select id="statusContaBancaria" name="statusContaBancaria" data-select-id="jjwp9od" class="initialized">
                                 <option value=""></option>
                     ...
                     <th class="sorting" tabindex="0" aria-controls="fly01dt" rowspan="1" colspan="1" style="width: 113px;" aria-label="Nº: Ordenar colunas de forma ascendente">
                        <div id="numeroField" class="input-field fly01dt-filter "><input id="numero" name="numero" class="number" data-index="1" type="text"><label class="truncate" for="numero">Nº</label></div>
                     </th>
                     <th class="sorting" tabindex="0" aria-controls="fly01dt" rowspan="1" colspan="1" style="width: 134px;" aria-label="Vencimento: Ordenar colunas de forma ascendente">
                        <div id="dataVencimentoField" class="input-field fly01dt-filter "><input id="dataVencimento" name="dataVencimento" class="date" data-index="2" type="text"><label class="truncate" for="dataVencimento">Vencimento</label></div>
                     </th>
                     ...
                     <th class="sorting" tabindex="0" aria-controls="fly01dt" rowspan="1" colspan="1" style="width: 125px;" aria-label="Valor: Ordenar colunas de forma ascendente">
                        <div id="valorPrevistoField" class="input-field fly01dt-filter "><input id="valorPrevisto" name="valorPrevisto" class="currency" data-index="4" style="text-align: right;" type="text"><label class="truncate" for="valorPrevisto">Valor</label></div>
                     </th>
