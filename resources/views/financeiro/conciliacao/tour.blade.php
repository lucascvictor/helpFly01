      ...
      var enjoyhint_script_data = [
       {
        ...
        {
          'next .btn-narrow': 'Clique neste ícone para abrir a tela de upload do extrato.',
          'nextButton' : {className: 'myNext', text: 'Próximo'},
          'skipButton' : {className: 'mySkip', text: 'Sair'},
        },
        {
        ...
        {
          'next #save': 'Com a conta preenchida e o arquivo OFX selecionado, basta clicar em "IMPORTAR CADASTRO".',
          'nextButton' : {className: 'myNext', text: 'Próximo'},
          'skipButton' : {className: 'mySkip', text: 'Sair'},
        },
