    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col s12">
                ...
                <div class="card-panel teal amber accent-2 app center">Esta é a tela inicial da rotina, a seleção de títulos que serão renegociados, é pesquisada através dos fornecedores, por isso primeiramente é necessário selecioná-los, após isso clique em "Listar Contas" e os títulos em abertos do fornecedor escolhido irão aparecer.</div>
                    <img class="responsive-img z-depth-5" src="{{ url('images/cadastros/contasAPagar/Renegotiation/Tela1.gif') }}">
                   
                    <div class="card-panel teal amber accent-2 app center">Vale ressaltar que após a lista de títulos aparecer, para selecionar os títulos  basta clicar em cima dos mesmos, podendo sempre escolher um ou mais títulos.</div>
                    <img class="responsive-img z-depth-5" src="{{ url('images/cadastros/contasAPagar/Renegotiation/Tela2.gif') }}">
                   
                    <div class="card-panel teal amber accent-2 app center">Em "Informações da renegociação" preenchemos o motivo da renegociação, informamos se haverá acréscimo ou desconto, se a diferença será calculada diretamente por valor ou porcentagem e por fim informamos o percentual ou valor da diferença.</div>
