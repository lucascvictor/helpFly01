   ...
   <li class="no-padding">
        ...
        <li class="no-padding">
            <ul class="side collapsible">
                <li class=""><a href="javascript:void(0)" onclick="fly01.go(&quot;/Home/List&quot;)">Aplicativos</a></li>
                <li class=""><a href="javascript:void(0)" onclick="fly01.go(&quot;/Empresa/Form&quot;)">Empresa</a></li>
                <li class=""><a href="javascript:void(0)" onclick="fly01.go(&quot;/User/List&quot;)">Usuários</a></li>
